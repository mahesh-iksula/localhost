    ...
    $(function()
    {
        ...
        WEBAPP = {
            ...
            eventHandlers: function() {
                ...
                {
                    WEBAPP.cache.$captchaImg.attr("src","/test-captcha/php/newCaptcha.php?rnd=" + Math.random());
                });
            },
                ...
                WEBAPP.cache.$form.validate({
                   ...
                   rules: {
                        ...
                        "captcha": {
                            ...
                            "remote" :
                            {
                              url: '/test-captcha/php/checkCaptcha.php',
                              type: "post",
                              data:
                              {
                                  code: function()
                    ...
                    submitHandler: function(form)
                    {
                        ...
                        /*var submitRequest = $.ajax({
                             type: "POST",
                             url: "/test-captcha/php/dummyScript.php",
                             data: {
