...
';
$query = "SELECT * FROM `mcat` ";
$result=mysql_query($query);
while($row=mysql_fetch_array($result)){
echo'<tr>
		<td>'.$row['mcatid'].'</td>
		<td>'.$row['mcatname'].'</td>
		<td><a href="" class="floatl" ><img src="images/view.png" alt="" border="0" ></a><a href="edit_mcat.php?mcatid=\''.$row['mcatid'].'\'" class="floatl" ><img src="images/edit.png" alt="" border="0" ></a><a href="delete.php?DELETE+FROM+`mcat`+WHERE+`mcatid`=\''.$row['mcatid'].'\'" class="floatl" onclick="return confirm(\'Are you sure you want to delete?\')"  ><img src="images/delete.png" alt="" border="0" ></a></td>
	</tr>';
}
