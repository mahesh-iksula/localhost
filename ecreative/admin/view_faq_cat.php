...
foreach($sonyPages as $row){echo'<tr>
		...
		<td><a href="edit_faq_cat.php?faqscatid='.$row['faqscatid'].'" class="floatl" ><img src="images/edit.png" alt="" border="0" ></a><a href="delete.php?DELETE+FROM+`faqs_cat`+WHERE+`faqscatid`=\''.$row['faqscatid'].'\'" class="floatl" onclick="return confirm(\'Are you sure you want to delete?\')"  ><img src="images/delete.png" alt="" border="0" ></a></td>
	</tr>';
}
