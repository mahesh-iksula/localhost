...
';
$query = "SELECT * FROM `st_lc` ORDER BY `st_id` DESC ";
...
//execute the SQL query and return records
	...
	echo'
	<a href="add_store.php" class="pink mart10 floatl">Add Store</a>
...
echo'<tr>
		<td>'.$row['st_id'].'</td>
		<td>'.$row['st_name'].'</td>
		<td><a href="view_store.php?st_id='.$row['st_id'].'" class="floatl" ><img src="images/view.png" alt="" border="0" ></a><a href="edit_store.php?st_id='.$row['st_id'].'" class="floatl" ><img src="images/edit.png" alt="" border="0" ></a><a href="delete.php?DELETE+FROM+`st_lc`+WHERE+`st_id`=\''.$row['st_id'].'\'" class="floatl" onclick="return confirm(\'Are you sure you want to delete?\')"  ><img src="images/delete.png" alt="" border="0" ></a></td>
	</tr>';
}
echo'<tr>
